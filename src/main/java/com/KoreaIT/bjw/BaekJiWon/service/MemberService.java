...
import com.KoreaIT.bjw.BaekJiWon.repository.MemberRepository;
...
public class MemberService {
	...
	public ResultData<Integer> join(String email, String loginPw, String name, String nickname, String cellphoneNum) {
		// 로그인 아이디 중복체크
		Member existsMember = getMemberByLoginId(email);
		...
		// 중복체크 후 회원가입처리
		memberRepository.join(email, loginPw, name, nickname, cellphoneNum, email);
	...
	public ResultData modify(int id, String loginPw, String name, String nickname, String cellphoneNum) {
		memberRepository.modify(id, loginPw, name, nickname, cellphoneNum);
